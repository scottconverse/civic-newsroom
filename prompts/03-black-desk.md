...
**The Black Desk is Stage 0 of the pipeline. It does not produce journalism. It produces the questions that make journalism possible.**
...
|------------------|--------------------------|------------------------------|
| Source tier       | Tier C (social, anecdotal) + Tier B/A for structural anchor | Tier A/B primary; Tier C only if verified |
...
- Tier A document required to convert speculation to fact
  ...
  and official municipal YouTube channel transcripts.
...
1. It Validates Noise. Unlike the Dark Signal Desk, which ignores Tier C unless
   verified, the Black Desk treats Tier C noise as the starting point. Suppressing
   anecdotes kills investigations before they begin.
